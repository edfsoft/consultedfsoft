...
<body>
            ...
            <ul class="d-flex align-items-center ms-5">
                <li class="nav-item dropdown d-flex justify-content-evenly">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile" style="box-shadow: 0 0 10px 5px rgba(0, 0, 0, 0.2);">
                        ...
                        <li>
                            <a href="<?php echo base_url() . "Edfadmin/logout" ?>" class="dropdown-item d-flex align-items-center text-danger" onclick="return confirm('Are you sure to logout?')">
    ...
    <aside id="sidebar" class="sidebar" style="background-color: #222d32">
        <ul class="sidebar-nav pt-5 ps-4" id="sidebar-nav">
            <li class="">
                <a class="" href="<?php echo base_url() . "Edfadmin/dashboard" ?>" id="dashboard" style="font-size: 18px; font-weight: 400;color:#8cafba;">
            ...
            <li class="pt-4">
                <a class="" style="font-size: 18px; font-weight: 400;color:#8cafba;" id="ccs" href="<?php echo base_url() . "Edfadmin/ccList" ?>">
                    <div><i class="bi bi-person-check pe-3"></i></i> <span>CC</span></div>
                </a>
            </li>

            <li class="pt-4">
                <a class="" href="<?php echo base_url() . "Edfadmin/hcpList" ?>" style="font-size: 18px; font-weight: 400;color:#8cafba;" id="hcps">
                    <div>
            ...
            <li class="pt-4">
                <a class="" href="<?php echo base_url() . "Edfadmin/patientList" ?>" style="font-size: 18px; font-weight: 400;color:#8cafba;" id="patients">
                    <div>
            ...
            <li class="pt-4">
                <a class="" href="<?php echo base_url() . "Edfadmin/specializationList" ?>" style="font-size: 18px; font-weight: 400;color:#8cafba;" id="specialization">
                    <div>
            ...
            <li class="pt-4">
                <a class="" href="<?php echo base_url() . "Edfadmin/symptomsList" ?>" style="font-size: 18px; font-weight: 400;color:#8cafba;" id="symptoms">
                    <div>
            ...
            <li class="pt-4">
                <a class="" href="<?php echo base_url() . "Edfadmin/medicinesList" ?>" style="font-size: 18px; font-weight: 400;color:#8cafba;" id="medicines">
                    <div>
    ...
    <main id="main" class="main">
                ...
                <div class="card rounded">
                    <div class="d-sm-flex justify-content-between mt-2 p-2 pt-sm-4 px-sm-4">
                        ...
                        <a href="<?php echo base_url() . "Edfadmin/ccSignupForm" ?>">
                            <button style="background-color: #0081ff;" class="text-light border-0 rounded d-block d-sm-inline mx-auto mx-sm-0 p-2 mb-3">
                    ...
                    <div class="input-group mx-auto" style="width:250px;">
                        ...
                        <input type="text" id="searchInputCc" class="form-control" placeholder="Search by name" aria-describedby="searchIconCc">
            ...
            <section>
                <div class="card rounded">
                    <div class="d-flex justify-content-between mt-2 p-2 pt-sm-4 px-sm-4">
                        ...
                        <a href="<?php echo base_url() . "Edfadmin/ccList" ?>" class="text-dark"><i class="bi bi-arrow-left"></i> Back</a>
                    </div>

                    <div class="card-body col-md-8 p-2 px-sm-4">
                        <p style="font-size: 20px; font-weight: 500">Create an Account for Chief Consultant</p>
                        <form action="<?php echo base_url() . "Edfadmin/ccSignup" ?>" method="post" name="signupform" onsubmit="return validateSignup()" oninput="return removeError()">
                            <div class="mb-3">
                                <label for="ccName" class="form-label">Name <span class="text-danger">*</span></label>
                                <input type="text" name="ccName" id="ccName" placeholder="Suresh Kumar" class="form-control">
                                <div id="name_err" class="text-danger pt-1"></div>
                            </div>
                            <div class="mb-3">
                                <label for="ccMobile" class="form-label">Mobile <span class="text-danger">*</span></label>
                                <input type="number" name="ccMobile" id="ccMobile" placeholder="9876543210" class="form-control">
                                <div id="mobile_err" class="text-danger pt-1"></div>
                            </div>
                            <div class="mb-3">
                                <label for="ccEmail" class="form-label">Email <span class="text-danger">*</span></label>
                                <input type="email" name="ccEmail" id="ccEmail" placeholder="example@gmail.com" class="form-control">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="password" name="ccPassword" id="ccPassword" placeholder="password" class="form-control">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="password" name="ccCnfmPassword" id="ccCnfmPassword" placeholder="confirm password" class="form-control">
                ...
                <div class="card rounded">
                    ...
                    <div class="card-body p-2 p-sm-4">
                            ...
                            ?>
                                ...
                                <div class="ps-sm-5">
                                    ...
                                    <div class="input-group">
                                        <input type="password" class="form-control" id="password" name="password" value='<?php echo $value['doctorPassword']; ?>' readonly>
                        ...
                        <?php if ($value['approvalStatus'] == "0") { ?>
                            ...
                            <p>Please review the details and approve the Chief Consultant for login : <a href="<?php echo base_url() . "Edfadmin/approveCc/" . $value['id'] ?>" onclick="return confirm('The details have been verified and approved for login.')"><button class="btn btn-success px-2 py-1">Approve</button></a> </p>
                    <?php }
                            } ?>
                    </div>
                </div>
            ...
            <section>
                <div class="card rounded">
                    ...
                    <div class="input-group mx-auto" style="width:250px;">
                        ...
                        <input type="text" id="searchInputHcp" class="form-control" placeholder="Search by name" aria-describedby="searchIconHcp">
            ...
            <section>
                <div class="card rounded">
                    <div class="d-flex justify-content-between mt-2 p-2 pt-sm-4 px-sm-4">
                        ...
                        <a href="<?php echo base_url() . "Edfadmin/hcpList" ?>" class="text-dark"><i class="bi bi-arrow-left"></i> Back</a>
                    </div>

                    <div class="card-body col-md-8 p-2 px-sm-4">
                        <p style="font-size: 20px; font-weight: 500">Create an Account for Health Care Provider</p>
                        <form action="<?php echo base_url() . "Edfadmin/hcpSignup" ?>" method="post" name="hcpsignupform" onsubmit="return validateSignup()" oninput="return removeError()">
                            <div class="mb-3">
                                <label for="hcpName" class="form-label">Name <span class="text-danger">*</span></label>
                                <input type="text" name="hcpName" id="hcpName" placeholder="Suresh Kumar" class="form-control">
                                <div id="name_err" class="text-danger pt-1"></div>
                            </div>
                            <div class="mb-3">
                                <label for="hcpMobile" class="form-label">Mobile <span class="text-danger">*</span></label>
                                <input type="number" name="hcpMobile" id="hcpMobile" placeholder="9876543210" class="form-control">
                                <div id="mobile_err" class="text-danger pt-1"></div>
                            </div>
                            <div class="mb-3">
                                <label for="hcpEmail" class="form-label">Email <span class="text-danger">*</span></label>
                                <input type="email" name="hcpEmail" id="hcpEmail" placeholder="example@gmail.com" class="form-control">
                                <div id="mail_err" class="text-danger pt-1"></div>
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="password" name="hcpPassword" id="hcpPassword" placeholder="password" class="form-control">
                                <div id="password_err" class="text-danger pt-1"></div>
                            </div>
                            <div class="text-secondary mb-3" style="font-size:12px;display:none;" id="passwordmessage">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="password" name="hcpCnfmPassword" id="hcpCnfmPassword" placeholder="confirm password" class="form-control">
                                <div id="cnfmpassword_err" class="text-danger pt-1"></div>
                            </div>
                            <input type="hidden" name="approvalApproved" id="approvalApproved" value="1">
                            <button type="submit" class="btn btn-secondary text-light float-end mt-2">Sign
            ...
            <section>
                <div class="card rounded">
                    ...
                    <div class="card-body p-2 p-sm-4">
                        <div class="d-flex justify-content-start mt-2 mb-5">
                            ...
                            ?>
                                ...
                                <div class="ps-sm-5">
                                    ...
                                    <div class="input-group">
                                        <input type="password" class="form-control" id="password" name="password" value='<?php echo $value['hcpPassword']; ?>' readonly>
                                        <button type="button" class="btn btn-outline-secondary" onclick="togglePasswordVisibility('password', 'visibilityIcon')">
                                            <i id="visibilityIcon" class="bi bi-eye-slash"></i>
                                        </button>
                                    </div>
                        ...
                        <?php if ($value['approvalStatus'] == "0") { ?>
                            <h5 class="my-3 fw-bolder">Profile Approval Process:</h5>
                            <p>Please review the details and approve the Health Care Provider for login : <a href="<?php echo base_url() . "Edfadmin/approveHcp/" . $value['id'] ?>" onclick="return confirm('The details have been verified and approved for login.')"><button class="btn btn-success px-2 py-1">Approve</button></a> </p>
                    <?php }
                            } ?>
                    </div>
                    ...
                    <div class="card-body p-2 p-sm-4">
                        <div class="d-sm-flex justify-content-between mt-2 mb-3">
                            ...
                            <div class="input-group" style="width:250px;">
                                ...
                                <input type="text" id="searchInputPatient" class="form-control" placeholder="Search by name" aria-describedby="searchIconPatient">
                ...
                <div class="card rounded">
                    <div class="card-body p-2 p-sm-4">
                        <div class="d-sm-flex justify-content-between mt-2 mb-3 p-2 pt-sm-4 px-sm-4">
                            ...
                            <button style="background-color: #0081ff;" type="button" data-toggle="modal" data-target="#newSpecilization" class="text-light border-0 rounded d-block d-sm-inline mx-auto mx-sm-0 p-2 mb-3">
                        ...
                        <div class="input-group mx-auto pb-4" style="width:260px;">
                            ...
                            <input type="text" id="searchInputSpecialization" placeholder="Search Specializations" class="form-control">
                            <button class="btn btn-outline-secondary" id="clearSearchSpecialization"> <i class="bi bi-x"></i></button>
                        </div>
                ...
                <div class="card rounded">
                    <div class="card-body p-2 p-sm-4">
                        <div class="d-sm-flex justify-content-between mt-2 mb-3 p-2 pt-sm-4 px-sm-4">
                            ...
                            <button style="background-color: #0081ff;" type="button" data-toggle="modal" data-target="#newSymptoms" class="text-light border-0 rounded d-block d-sm-inline mx-auto mx-sm-0 p-2 mb-3">
                                <i class="bi bi-plus-square-fill"></i> New
                            </button>
                        </div>
                        <div class="input-group mx-auto pb-4" style="width:260px;">
                            ...
                            <button class="btn btn-outline-secondary" id="clearSearchSymptoms"> <i class="bi bi-x"></i></button>
                        </div>
                ...
                <div class="card rounded">
                    <div class="card-body">
                        ...
                        <div class="d-sm-flex justify-content-between mt-2 p-2 pt-sm-4 px-sm-4">
                            ...
                            <button style="background-color: #0081ff;" type="button" data-toggle="modal" data-target="#newMedicine" class="text-light border-0 rounded d-block d-sm-inline mx-auto mx-sm-0 p-2 mb-3">
                                <i class="bi bi-plus-square-fill"></i> New
                            </button>
                        </div>
                        ...
                        <div class="input-group mx-auto pb-4" style="width:250px;">
                            ...
                            <input type="text" id="searchInputMedicines" placeholder="Search Medicines" class="form-control">
                            <button class="btn btn-outline-secondary" id="clearSearchMedicines"> <i class="bi bi-x"></i></button>
                        </div>
        ...
        <div class="modal fade" id="newSpecilization" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="<?php echo base_url() . "Edfadmin/addNewSpecilization" ?>" name="addSpecilization" name="addSpecilization" enctype="multipart/form-data" method="POST">
                            <label for="specializationName" class="form-label pb-2">Specilization Name <span class="text-danger">*</span></label><br>
                            <input type="text" name="specializationName" id="specializationName" class="form-control" placeholder="E.g. Diabetologist" required><br><br>
        ...
        <div class="modal fade" id="newSymptoms" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                    ...
                    <div class="modal-body">
                        <form action="<?php echo base_url() . "Edfadmin/addNewSymptoms" ?>" name="addSymptoms" enctype="multipart/form-data" method="POST">

                            <label for="symptomsName" class="form-label pb-2">Symptom / Complaint Name <span class="text-danger">*</span></label><br>
                            <input type="text" name="symptomsName" id="symptomsName" class="form-control" placeholder="E.g. Head ache" required><br><br>
                            <button type="submit" class="btn btn-secondary float-end"> Add </button>
                        </form>
                    </div>
                </div>
        ...
        <div class="modal fade" id="newMedicine" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                    ...
                    <div class="modal-body">
                        <form action="<?php echo base_url() . "Edfadmin/addNewMedicine" ?>" name="addMedicine" enctype="multipart/form-data" method="POST">
                            <label for="medicineNameBrand" class="form-label pb-2">Medicine Brand Name <span class="text-danger">*</span></label><br>
                            <input type="text" name="medicineNameBrand" id="medicineNameBrand" class="form-control" placeholder="E.g. Dolo 650" required><br>
                            <label for="medicineName" class="form-label pb-2">Medicine Name <span class="text-danger">*</span></label><br>
                            <input type="text" name="medicineName" id="medicineName" class="form-control" placeholder="E.g.  Paracetamol" required><br>
                            <label for="maedicineStrength" class="form-label pb-2">Medicine Strength <span class="text-danger">*</span></label><br>
                            <input type="text" name="maedicineStrength" id="maedicineStrength" class="form-control" placeholder="E.g.  100 mg" required><br><br>
                            <button type="submit" class="btn btn-secondary float-end"> Add </button>
                        </form>
                    </div>
                </div>
