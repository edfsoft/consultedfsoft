...
<body>
    ...
    <main id="main" class="main">
                                ...
                                <?php } ?>
                                        ...
                                        <?php echo $value['doctorName']; ?>
                                            ...
                                            <?php echo $value['doctorMail']; ?>
                                                ...
                                                <p class=""><?php echo $value['gMeetLink']; ?>
                                                <button class="me-1 btn btn-primary" type="button" data-toggle="modal"
                                              data-target="#appointmentLink"><i class="bi bi-link-45deg"></i></button></p>
                                            </div>
                                            </div>
                                        </div>
        ...
        <!-- Popup Appointment add new link CC -->
        <div class="modal fade" id="appointmentLink" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
            aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">Add Appointment Link </h5>
                        <button type="button" class="close btn btn-outline-danger" data-dismiss="modal"
                            aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    ...
                    <div class="m-3"  >
                        <form action="<?php echo base_url() . "Edfadmin/addAppLink" ?>" method="POST" name="appLinkForm" >
                    <label for="appLink" class="pb-2" >Add Google Meet Link <span class="text-danger">*</span></label><br>
                    <input type="text" class="form-control" name="appLink" id="appLink" placeholder="Enter Link" required><br>
                    <input type="number" class="form-control" name="ccIdDb" id="ccIdDb" placeholder="Enter table Id in URL" required><br>
                    <button type="submit" class="btn btn-secondary mt-2 float-end" >Submit</button>
                    </form> 
                     </div>
