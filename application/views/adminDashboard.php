                                 ...
                                 data-type="medicine"><i class="bi bi-trash"></i>
                                                                                ...
                                                                                <script>
                                                                                    ...
                                                                                    function openAddMedicineModal() {
                                                                                        ...
                                                                                        // Set up the modal for "Add" mode
                                                                                        modalLabel.innerText = "Add New Medicine";
                                                                                        ...
                                                                                        if (medicineForm) {
                                                                                            medicineForm.addEventListener('submit', function (e) {
                                                                                                ...
                                                                                                if (submitButton) {
                                                                                                    ...
                                                                                                    // 1. Read the button's current text
                                                                                                    const currentText = submitButton.innerText.trim();
                                                                                                    let loadingText = "Adding...";

                                                                                                    // 2. Check if the text is "Update"
                                                                                                    if (currentText.toLowerCase() === 'update') {
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            function enablePdfZoom() {
                ...
                zoomInBtn.onclick = () => {
                    pdfZoom = Math.min(pdfZoom + ZOOM_STEP, MAX_ZOOM);
                    setPdfZoom();
                };
                zoomOutBtn.onclick = () => {
                    pdfZoom = Math.max(pdfZoom - ZOOM_STEP, MIN_ZOOM);
                    setPdfZoom();
                };
            }
