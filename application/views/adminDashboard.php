        ...
        if ($method == "dashboard") {
                            ...
                            <script>
                                ...
                                function generatePagination(totalItems, currentPage) {
                                    ...
                                    for (let i = 1; i <= totalPages; i++) {
                                        ...
                                        pageButton.classList.add('btn', 'border', 'px-3', 'py-2');
                                        if (i === currentPage) {
                                            pageButton.classList.add('btn-secondary', 'text-light');
                                        }
                                        pageButton.addEventListener('click', () => displayHcpPage(i));
            ...
            ?>
                                        ...
                                        <script>
                                            ...
                                            console.log("Patient List:", patientList); // Debugging
                                            ...
                                            function displayPatientPage(page) {
                                                console.log("Display Page:", page); // Debugging
