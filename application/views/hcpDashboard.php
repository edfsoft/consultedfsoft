                        ...
                        if (itemsToShow.length === 0) {
                            ...
                            itemsToShow.forEach((value, index) => {
                                ...
                                const prescriptionButton = value.consultedOnce === '1' ?
                                    '<a href="<?php echo base_url(); ?>Healthcareprovider/prescriptionView/' + value.id + '"><button class="btn btn-secondary"><i class="bi bi-prescription"></i></button></a>' :
                                    '<button class="btn btn-secondary" disabled><i class="bi bi-prescription"></i></button>';
                                ...
                                patientRow.innerHTML =
                                    ...
                                    '<a href="<?php echo base_url(); ?>Healthcareprovider/patientformUpdate/' + value.id + '"><button class="btn btn-secondary"><i class="bi bi-pencil"></i></button></a>' +
                                    '<a href="<?php echo base_url(); ?>Healthcareprovider/patientdetails/' + value.id + '" class="px-1"><button class="btn btn-success"><i class="bi bi-eye"></i></button></a>' +
                                    prescriptionButton +
                                    '</td>';
                            ...
                            if ($value['consultedOnce'] === "1") {
                                ?>
                                    ...
                                    foreach ($patientAppHistory as $key => $svalue) {
                                        ?>
                                                    <div class="card rounded mt-3 p-4">
                                                        <div class="d-sm-flex" style="font-weight:600;">
                                                            <p class="pe-4"><?php echo date('d F Y', strtotime($svalue['dateOfAppoint'])); ?> -
                                                <?php echo date('h:i A', strtotime($svalue['timeOfAppoint'])); ?>
                                                            </p>
                                                            <p class="pe-4"><?php echo $svalue['patientComplaint'] ?> </p>
                                                        </div>
                                                        <div class="d-sm-flex pb-1">
                                                            <p class="text-secondary col-md-2 mb-1" style="font-weight:500;">CC Id : </p>
                                                        ...
                                                        <p class="text-secondary">Medicines : </p>
                                                    </div>
                                <?php } ?>
                                                                        ...
                                                                        <div class="card -3">
                                                                            ...
                                                                            <div class="card-body">
                                                                                ...
                                                                                <div class="form-group pb-3">
                                                                                    ...
                                                                                    <div id="preMedDuration_err" class="text-danger pt-1"></div>
                                                                                </div>
                                                                                <div class="form-group pb-3">
                                                    ...
                                                    function validateMedicines() {
                                                        ...
                                                        medicineEntries.forEach(function (entry) {
                                                            ...
                                                            if (durationUnitSelect.value.trim() === "") {
                                                                entry.querySelector("#preMedDuration_err").innerHTML = "Please select a duration unit.";
                                                                allFilled = false;
                                                            } else {
                                                                entry.querySelector("#preMedDuration_err").innerHTML = "";
                                                            }
