...
<body>
        ...
        <nav class="header-nav ms-auto">
            <ul class="d-flex align-items-center ms-5">
                <li class="nav-item dropdown d-flex justify-content-evenly">
                    ...
                    <img src="<?php echo base_url(); ?>assets/BlankProfile.jpg" width="40" height="40" alt="Profile" class="rounded-circle me-1" />
                    ...
                    <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile" style="box-shadow: 0 0 10px 5px rgba(0, 0, 0, 0.2);">
                        ...
                        <li>
                            <a class="dropdown-item d-flex align-items-center" href="<?php echo base_url() . "Healthcareprovider/myProfile" ?>">
                        ...
                        <li>
                            <a href="<?php echo base_url() . "Healthcareprovider/logout" ?>" class="dropdown-item d-flex align-items-center text-danger" onclick="return confirm('Are you sure to logout?')">
    ...
    <aside id="sidebar" class="sidebar" style="background-color: #00ad8e">
        <ul class="sidebar-nav pt-5 ps-4" id="sidebar-nav">
            <li class="">
                <a class="" href="<?php echo base_url() . "Healthcareprovider/dashboard" ?>" id="dashboard" style="font-size: 18px; font-weight: 400;color:white;">
            ...
            <li class="pt-4">
                <a class="" style="font-size: 18px; font-weight: 400;color:white;" id="patients" href="<?php echo base_url() . "Healthcareprovider/patients" ?>">
                    <div><i class="bi bi-person pe-3"></i> <span>Patients</span></div>
                </a>
            </li>

            <li class="pt-4">
                <a class="" href="<?php echo base_url() . "Healthcareprovider/appointments" ?>" style="font-size: 18px; font-weight: 400;color:white;" id="appointments">
                    <div>
            ...
            <li class="pt-4">
                <a class="" href="<?php echo base_url() . "Healthcareprovider/chiefDoctors" ?>" style="font-size: 18px; font-weight: 400;color:white;" id="chiefDoctor">
                    <div>
            ...
            <li class="pt-4">
                <a class="" href="<?php echo base_url() . "Healthcareprovider/logout" ?>" style="font-size: 18px; font-weight: 400;color:white;" id="logout" onclick="return confirm('Are you sure to logout?')">
                    <div>
                                                ...
                                                <tr>
                                                    <td class="px-4">
                                                        <?php if (isset($appointmentList[0]['profilePhoto']) && $appointmentList[0]['profilePhoto'] != "No data") { ?>
                                                            <img src="<?php echo base_url() . 'uploads/' . $appointmentList[0]['profilePhoto'] ?>" alt="Profile Photo" width="40" height="40" class="rounded-circle">
                                                        <?php } else { ?>
                                                            <img src="<?php echo base_url(); ?>assets/BlankProfile.jpg" alt="Profile Photo" width="40" height="40" class="rounded-circle">
                                                        <?php } ?>
                                                    </td>
                                                    <td class="px-5">
                                                        <span style="font-size: 16px; font-weight: 500; color: #00ad8e"><?php echo $appointmentList[0]['patientId']; ?></span><br /><span style="font-size: 16px">
                                                ...
                                                <tr>
                                                    <td class="px-3">
                                                        <?php if (isset($appointmentList[1]['profilePhoto']) && $appointmentList[1]['profilePhoto'] != "No data") { ?>
                                                            <img src="<?php echo base_url() . 'uploads/' . $appointmentList[1]['profilePhoto'] ?>" alt="Profile Photo" width="40" height="40" class="rounded-circle">
                                                        <?php } else { ?>
                                                            <img src="<?php echo base_url(); ?>assets/BlankProfile.jpg" alt="Profile Photo" width="40" height="40" class="rounded-circle">
                                                        <?php } ?>
                                                    </td>
                                                    <td class="px-5">
                                                        <span style="font-size: 16px; font-weight: 500; color: #00ad8e"><?php echo $appointmentList[1]['patientId']; ?></span><br /><span style="font-size: 16px">
                                                ...
                                                <tr>
                                                    <td>
                                                        <?php if (isset($appointmentList[2]['profilePhoto']) && $appointmentList[2]['profilePhoto'] != "No data") { ?>
                                                            <img src="<?php echo base_url() . 'uploads/' . $appointmentList[2]['profilePhoto'] ?>" alt="Profile Photo" width="40" height="40" class="rounded-circle">
                                                        <?php } else { ?>
                                                            <img src="<?php echo base_url(); ?>assets/BlankProfile.jpg" alt="Profile Photo" width="40" height="40" class="rounded-circle">
                                                        <?php } ?>
                                                    </td>
                                                    <td class="px-5">
                                                        <span style="font-size: 16px; font-weight: 500; color: #00ad8e"><?php echo $appointmentList[2]['patientId']; ?></span><br /><span style="font-size: 16px">
                            ...
                            <?php if (isset($appointmentList[0]['id'])) { ?>
                                <div class="d-flex justify-content-evenly">
                                    <?php if (isset($value['profilePhoto']) && $value['profilePhoto'] != "No data") { ?>
                                        <img src="<?php echo base_url() . 'uploads/' . $value['profilePhoto'] ?>" alt="Profile Photo" width="50" height="50" class="rounded-circle">
                                    <?php } else { ?>
                                        <img src="<?php echo base_url(); ?>assets/BlankProfile.jpg" alt="Profile Photo" width="50" height="50" class="rounded-circle">
                                    <?php } ?>
                                    <p class="px-5">
                                        <span style="font-size: 16px; font-weight: 500; color: #00ad8e">Name</span><br /><span style="font-size: 16px">
                                    ...
                                    <p>
                                        <span style="font-size: 16px; font-weight: 500; color: #00ad8e">Patient
                                            ID</span><br /><span style="font-size: 16px"><?php echo $appointmentList[0]['patientId']; ?></span>
                                    </p>
                                </div>
                                <div class="table-responsive">
                                    <table class="table">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>
                                                    <span style="font-size: 16px; font-weight: 400"><?php echo $appointmentList[0]['age']; ?></span>
                                                </td>
                                                <td>
                                                    <span style="font-size: 16px; font-weight: 400"><?php echo $appointmentList[0]['gender']; ?></span>
                                                </td>
                                                <td>
                                                    <span style="font-size: 16px; font-weight: 400"><?php echo isset($appointmentList[0]['bloodGroup']) ? $appointmentList[0]['bloodGroup'] : '-' ?></span>
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
                                    <table class="table">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>
                                                    <span style="font-size: 16px; font-weight: 400"><?php echo $appointmentList[0]['patientComplaint']; ?></span>
                                                </td>
                                                <!-- <td class="px-5">
                                                    <span style="font-size: 16px; font-weight: 400">172cm</span>
                                                </td> -->
                                                <td>
                                                    <span style="font-size: 16px; font-weight: 400"><?php echo $appointmentList[0]['referalDoctor']; ?></span>
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
                                ...
                                <div>
                                    <a href="tel:<?php echo $appointmentList[0]['mobileNumber']; ?>"><button style=" background-color: #00ad8e; color: white; font-size: 16px;" class="border border-1 rounded p-2 p-md-3">
                                            <i class="bi bi-telephone"></i> +91
                                            <?php echo $appointmentList[0]['mobileNumber']; ?>
                                        </button></a>
                                    <?php if ($appointmentList[0]['documentOne'] != "No data") { ?>
                                        <a href="<?php echo base_url() . 'uploads/' . $appointmentList[0]['documentOne'] ?>" target="blank"><button style="border: 2px solid #00ad8e; background-color: white" class="rounded p-2 p-md-3 mt-2 mt-sm-0 mx-sm-2">
                                                <i class="bi bi-folder2"></i> Reports
                                            </button></a>
                                    <?php }
                                    if ($appointmentList[0]['documentTwo'] != "No data") { ?>
                                        <a href="<?php echo base_url() . 'uploads/' . $appointmentList[0]['documentTwo'] ?>" target="blank"><button style="border: 2px solid #00ad8e; background-color: white" class="rounded p-2 p-md-3 mt-2 mt-sm-0">
                ...
                <div class="card rounded">
                    <div class="d-sm-flex justify-content-between mt-2 p-2 pt-sm-4 px-sm-4">
                        ...
                        <div class="input-group my-2 my-sm-0" style="width:250px;">
                            ...
                            <input type="text" id="searchInputPatients" class="form-control" placeholder="Search by name" aria-describedby="searchIcon">
            ...
            <section>
                <div class="card rounded">
                    <div class="d-flex justify-content-between mt-2 p-2 pt-sm-4 px-sm-4">
                        ...
                        <a href="<?php echo base_url() . "Healthcareprovider/patients" ?>" class="float-end text-dark"><i class="bi bi-arrow-left"></i> Back</a>
                    </div>

                    <div class="card-body px-md-4 pb-4">
                        <div class="row">
                            <div class="col-md-8">
                                <form action="<?php echo base_url() . "Healthcareprovider/addPatientsForm" ?>" name="patientDetails" id="patientDetails" enctype="multipart/form-data" method="POST" oninput="clearErrorPatientDetails()" onsubmit="return validatePatientDetails()">
                                    <p class="pb-2" style="font-size: 20px; font-weight: 500;color:#00ad8e">
                                        <button style=" width:30px;height:30px;background-color: #00ad8e;font-size:20px; font-weight: 500" class="text-light rounded-circle border-0">1</button> Basic Details
                                    </p>
                                    <div class="form-group pb-3">
                                        <label class="form-label" for="patientName">First Name <span class="text-danger">*</span></label>
                                        <input type="text" class="form-control" id="patientName" name="patientName" placeholder="E.g. Siva">
                                        <div id="patientName_err" class="text-danger pt-1"></div>
                                    </div>
                                    <div class="form-group pb-3">
                                        <label class="form-label" for="patientLastName">Last Name</label>
                                        <input type="text" class="form-control" id="" name="patientLastName" placeholder="E.g. Kumar">
                                        <div id="patientLastName_err" class="text-danger pt-1"></div>
                                    </div>
                                    <div class="form-group pb-3">
                                        <label class="form-label" for="patientMobile">Moblie Number <span class="text-danger">*</span></label>
                                        <input type="number" class="form-control" id="patientMobile" name="patientMobile" placeholder="E.g. 9638527410">
                                        <div id="patientMobile_err" class="text-danger pt-1"></div>
                                    </div>
                                    <div class="form-group pb-3">
                                        <label class="form-label" for="patientAltMobile">Alternate Moblie
                                            Number</label>
                                        <input type="number" class="form-control" id="patientAltMobile" name="patientAltMobile" placeholder="E.g. 9876543210">
                                        <div id="patientMobile_err" class="text-danger pt-1"></div>
                                    </div>
                                    <div class="form-group pb-3">
                                        <label class="form-label" for="patientEmail">Email</label>
                                        <input type="mail" class="form-control" id="patientEmail" name="patientEmail" placeholder="E.g. example@gmail.com">
                                        <div id="patientEmail_err" class="text-danger pt-1"></div>
                                    </div>
                                    <div class="form-group pb-3">
                                        <label class="form-label" for="patientGender">Gender <span class="text-danger">*</span></label>
                                    ...
                                    <div class="form-group pb-2">
                                        <label class="form-label" for="patientAge">Age <span class="text-danger">*</span></label>
                                        <input type="number" class="form-control" id="patientAge" name="patientAge" min="0" placeholder="E.g. 41">
                                    ...
                                    <div class="form-group pb-3">
                                        ...
                                        <input type="text" class="form-control" id="marriedSince" name="marriedSince" placeholder="E.g. 2012">
                                    </div>

                                    <p class="pt-4 pb-2" style="font-size: 20px; font-weight: 500;color:#00ad8e">
                                        <button style=" width:30px;height:30px;background-color: #00ad8e;font-size:20px; font-weight: 500" class="text-light rounded-circle border-0">2</button> Additional
                                        Information
                                    </p>

                                    <div class="form-group pb-3">
                                        <label class="form-label" for="profilePhoto">Profile Photo</label>
                                        <input type="file" class="form-control" id="profilePhoto" name="profilePhoto" accept="image/png ,image/jpg, image/jpeg">
                                    </div>
                                    <div class="form-group pb-3">
                                        <label class="form-label" for="patientProfessions">Patient's
                                            Profession</label>
                                        <input type="text" class="form-control" id="patientProfessions" name="patientProfessions" placeholder="E.g. IT employee">
                                    </div>
                                    <div class="form-group pb-3">
                                        <label class="form-label" for="patientDoorNo">Door Number</label>
                                        <input type="text" class="form-control" id="patientDoorNo" name="patientDoorNo" placeholder="E.g. 96">
                                    </div>
                                    <div class="form-group pb-3">
                                        <label class="form-label" for="patientStreet">Street Address</label>
                                        <input type="text" class="form-control" id="patientStreet" name="patientStreet" placeholder="E.g. Abc street">
                                    </div>
                                    <div class="form-group pb-3">
                                        <label class="form-label" for="patientDistrict">District</label>
                                        <input type="text" class="form-control" id="patientDistrict" name="patientDistrict" placeholder="E.g. Erode">
                                    </div>
                                    <div class="form-group pb-3">
                                        <label class="form-label" for="patientPincode">Pincode</label>
                                        <input type="number" class="form-control" id="patientPincode" name="patientPincode" placeholder="E.g. 638001">
                                    </div>
                                    <div class="form-group pb-3">
                                        <label class="form-label" for="partnersName">Guardian's Name </label>
                                        <input type="text" class="form-control" id="partnersName" name="partnersName" placeholder="E.g. Rohith">
                                        <div id="partnersName_err" class="text-danger pt-1"></div>
                                    </div>
                                    <div class="form-group pb-3">
                                        <label class="form-label" for="partnerMobile">Guardian's Mobile </label>
                                        <input type="number" class="form-control" id="partnerMobile" name="partnerMobile" placeholder="E.g. 9874563210">
                                    ...
                                    <p class="pt-4 pb-2" style="font-size: 20px; font-weight: 500;color:#00ad8e">
                                        <button style=" width:30px;height:30px;background-color: #00ad8e;font-size:20px; font-weight: 500" class="text-light rounded-circle border-0">3</button> Medical Records
                                    </p>

                                    <div class="form-group pb-3">
                                        <label class="form-label" for="patientWeight">Weight </label>
                                        <div class="d-flex">
                                            <input type="number" class="form-control" id="patientWeight" name="patientWeight" min="0" placeholder="E.g. 50">
                                    ...
                                    <div class="form-group pb-3">
                                        ...
                                        <div class="d-flex">
                                            <input type="number" class="form-control" id="patientHeight" name="patientHeight" min="0" placeholder="E.g. 135">
                                    ...
                                    <div class="form-group pb-3">
                                        ...
                                        <div class="d-flex">
                                            <input type="number" class="form-control" id="patientBp" name="patientBp" placeholder="E.g. 100">
                                    ...
                                    <div class="form-group pb-3">
                                        ...
                                        <div class="d-flex">
                                            <input type="number" class="form-control" id="patientsCholestrol" name="patientsCholestrol" min="0" placeholder="E.g. 50">
                                    ...
                                    <div class="form-group pb-3">
                                        ...
                                        <div class="d-flex">
                                            <input type="number" class="form-control" id="patientBsugar" name="patientBsugar" min="0" placeholder="E.g. 200">
                                            <p class="mx-2 my-2">mmol/L</p>
                                        </div>
                                    </div>
                                    <div class="form-group pb-3">
                                        <label class="form-label" for="patientDiagonsis">Diagonsis <span class="text-danger">*</span></label>
                                        <textarea class="form-control" name="patientDiagonsis" id="patientDiagonsis" cols="" rows="" placeholder="E.g. Diabetes checkup"></textarea>
                                        <div id="diagonsis_err" class="text-danger pt-1"></div>
                                    </div>

                                    <div class="form-group pb-3">
                                        <label class="form-label" for="patientSymptoms">Symptoms / Complaints <span class="text-danger">*</span></label>
                                        <input type="text" id="patientSymptoms" name="patientSymptoms" readonly class="form-control" hidden>
                                        <div class="selected-values-container mb-2 p-2" id="selectedValuesContainer"> </div>
                                        <select class="form-control" id="multiSelectSymptoms" style="height:100px; " multiple>
                                            <?php
                                            $count = 0;
                                    ...
                                    <div class="form-group pb-3">
                                        ...
                                        <select class="form-control" id="patientMedicines" name="patientMedicines" oninput="addNewMedicines()">
                                    ...
                                    <div id="addMedicine" class="ps-4" style="display: none;">
                                        ...
                                        <div class="form-group mt-1 pb-2 col-9">
                                            ...
                                            <input type="text" class="form-control" id="newMedicineBrand" name="newMedicineBrand" placeholder="E.g. Dolo 650">
                                        </div>
                                        <div class="form-group pb-2 col-9">
                                            <label class="form-lael" for="newMedicineName">Medicine Name</label>
                                            <input type="text" class="form-control" id="newMedicineName" name="newMedicineName" placeholder="E.g. Paracetamol">
                                        </div>
                                        <div class="form-group pb-3 mb-2 col-9">
                                            <label class="form-lbel" for="newMedicineSrength">Medicine Strength</label>
                                            <input type="text" class="form-control" id="newMedicineSrength" name="newMedicineSrength" placeholder="E.g. 100 mg">
                                        </div>
                                    </div>
                                    <div class="form-group pb-3">
                                        <label class="form-label" for="medicalReceipts">Medical Receipts</label>
                                        <input type="file" class="form-control" id="medicalReceipts" name="medicalReceipts" accept="image/png ,image/jpg, image/jpeg,application/pdf">
                                    </div>
                                    <div class="form-group pb-3">
                                    ...
                                    <button type="submit" class="btn float-end text-light mt-2" style="background-color: #00ad8e;">Submit</button>
                                </form>
                            </div>
                        </div>
                    </div>
                            ...
                            ?>
                                <div class="row">
                                    <div class="position-relative mb-5">
                                        ...
                                        <?php if (isset($value['profilePhoto']) && $value['profilePhoto'] != "No data") { ?>
                                            <img src="<?php echo base_url() . 'uploads/' . $value['profilePhoto'] ?>" alt="Profile Photo" width="180" height="180" class="rounded-circle">
                                        <?php } else { ?>
                                            <img src="<?php echo base_url(); ?>assets/BlankProfile.jpg" alt="Profile Photo" width="180" height="180" class="rounded-circle">
                                        <?php } ?>
                                        <button class="position-absolute bottom-0 " type="button" data-toggle="modal" data-target="#updateProfile" onclick="patientPhotoUpdate('<?php echo $value['id'] ?>')"><i class="bi bi-pencil-square"></i></button>
                                    </div>
                                    <div class="col-md-8">

                                        <form action="<?php echo base_url() . "Healthcareprovider/updatePatientsForm" ?>" name="patientDetails" id="multi-step-form" enctype="multipart/form-data" method="POST" oninput="clearErrorPatientDetails()">
                                            <p class="ps-2 pb-2" style="font-size: 20px; font-weight: 500;color:#00ad8e">
                                                <button style=" width:30px;height:30px;background-color: #00ad8e;font-size:20px; font-weight: 500" class="text-light rounded-circle border-0">1</button> Basic Details
                                            </p>
                                            <div class="form-group pb-3">
                                                <label class="form-label" for="patientName">First Name <span class="text-danger">*</span></label>
                                                <input type="text" class="form-control" id="patientName" name="patientName" value="<?php echo $value['firstName'] ?>" placeholder="E.g. Siva">
                                                <div id="patientName_err" class="text-danger pt-1"></div>
                                            </div>
                                            <div class="form-group pb-3">
                                                <label class="form-label" for="patientLastName">Last Name</label>
                                                <input type="text" class="form-control" id="" name="patientLastName" value="<?php echo $value['lastName'] ?>" placeholder="E.g. Kumar">
                                                <div id="patientLastName_err" class="text-danger pt-1"></div>
                                            </div>
                                            <div class="form-group pb-3">
                                                <label class="form-label" for="patientMobile">Moblie Number <span class="text-danger">*</span></label>
                                                <input type="number" class="form-control" id="patientMobile" name="patientMobile" value="<?php echo $value['mobileNumber'] ?>" placeholder="E.g. 9638527410">
                                                <div id="patientMobile_err" class="text-danger pt-1"></div>
                                            </div>
                                            <div class="form-group pb-3">
                                                <label class="form-label" for="patientAltMobile">Alternate Moblie
                                                    Number</label>
                                                <input type="number" class="form-control" id="patientAltMobile" name="patientAltMobile" value="  <?php echo $value['alternateMobile'] ?>" placeholder="E.g. 9876543210">
                                                <div id="patientMobile_err" class="text-danger pt-1"></div>
                                            </div>
                                            <div class="form-group pb-3">
                                                <label class="form-label" for="patientEmail">Email</label>
                                                <input type="mail" class="form-control" id="patientEmail" name="patientEmail" value="<?php echo $value['mailId'] ?>" placeholder="E.g. example@gmail.com">
                                                <div id="patientEmail_err" class="text-danger pt-1"></div>
                                            </div>
                                            <div class="form-group pb-3">
                                                <label class="form-label" for="patientGender">Gender <span class="text-danger">*</span></label>
                                            ...
                                            <div class="form-group pb-2">
                                                <label class="form-label" for="patientAge">Age <span class="text-danger">*</span></label>
                                                <input type="number" class="form-control" id="patientAge" name="patientAge" min="0" value="<?php echo $value['age'] ?>" placeholder="E.g. 41">
                                                <div id="patientAge_err" class="text-danger pt-1"></div>
                                            </div>
                                            <div class="form-group pb-3">
                                                <label class="form-label" for="patientBlood">Blood Group</label>
                                            ...
                                            <div class="form-group pb-3">
                                                <label class="form-label" for="marriedSince">Married Since</label>
                                                <input type="text" class="form-control" id="marriedSince" value="<?php echo $value['marriedSince'] ?>" name="marriedSince" placeholder="E.g. 2012">
                                            </div>

                                            <p class="py-3" style="font-size: 20px; font-weight: 500;color:#00ad8e"> <button style=" width:30px;height:30px;background-color: #00ad8e;font-size:20px; font-weight: 500" class="text-light rounded-circle border-0">2</button> Additional Information
                                            </p>
                                            <div class="form-group pb-3">
                                                <label class="form-label" for="patientProfessions">Patient's
                                                    Profession</label>
                                                <input type="text" class="form-control" id="patientProfessions" name="patientProfessions" value="<?php echo $value['profession'] ?>" placeholder="E.g. IT employee">
                                            </div>
                                            <div class="form-group pb-3">
                                                <label class="form-label" for="patientDoorNo">Door Number</label>
                                                <input type="text" class="form-control" id="patientDoorNo" name="patientDoorNo" value="<?php echo $value['doorNumber'] ?>" placeholder="E.g. 96">
                                            </div>
                                            <div class="form-group pb-3">
                                                <label class="form-label" for="patientStreet">Street Address</label>
                                                <input type="text" class="form-control" id="patientStreet" name="patientStreet" value="<?php echo $value['address'] ?>" placeholder="E.g. Abc street">
                                            </div>
                                            <div class="form-group pb-3">
                                                <label class="form-label" for="patientDistrict">District</label>
                                                <input type="text" class="form-control" id="patientDistrict" name="patientDistrict" value="<?php echo $value['district'] ?>" placeholder="E.g. Erode">
                                            </div>
                                            <div class="form-group pb-3">
                                                <label class="form-label" for="patientPincode">Pincode</label>
                                                <input type="number" class="form-control" id="patientPincode" name="patientPincode" value="<?php echo $value['pincode'] ?>" placeholder="E.g. 638001">
                                            </div>
                                            <div class="form-group pb-3">
                                                <label class="form-label" for="partnersName">Guardian's Name </label>
                                                <input type="text" class="form-control" id="partnersName" name="partnersName" value="<?php echo $value['partnerName'] ?>" placeholder="E.g. Rohith">
                                                <div id="partnersName_err" class="text-danger pt-1"></div>
                                            </div>
                                            <div class="form-group pb-3">
                                                <label class="form-label" for="partnerMobile">Guardian's Mobile </label>
                                                <input type="number" class="form-control" id="partnerMobile" name="partnerMobile" value="<?php echo $value['partnerMobile'] ?>" placeholder="E.g. 9874563210">
                                                <div id="partnerMobile_err" class="text-danger pt-1"></div>
                                            </div>
                                            <div class="form-group pb-3">
                                                <label class="form-label" for="partnerBlood">Guardian's Blood Group</label>
                                            ...
                                            <p class="py-3" style="font-size: 20px; font-weight: 500;color:#00ad8e"> <button style=" width:30px;height:30px;background-color: #00ad8e;font-size:20px; font-weight: 500" class="text-light rounded-circle border-0">3</button> Medical Records
                                            </p>

                                            <div class="form-group pb-3">
                                                <label class="form-label" for="patientWeight">Weight </label>
                                                <div class="d-flex">
                                                    <input type="number" class="form-control" id="patientWeight" name="patientWeight" min="0" value="<?php echo $value['weight'] ?>" placeholder="E.g. 50">
                                                    <p class="mx-2 my-2">Kg</p>
                                                </div>
                                            </div>
                                            <div class="form-group pb-3">
                                                <label class="form-label" for="patientHeight">Height </label>
                                                <div class="d-flex">
                                                    <input type="number" class="form-control" id="patientHeight" name="patientHeight" min="0" value="<?php echo $value['height'] ?>" placeholder="E.g. 140">
                                                    <p class="mx-2 my-2">Cm</p>
                                                </div>
                                            </div>
                                            <div class="form-group pb-3">
                                                <label class="form-label" for="patientBp">Blood Pressure </label>
                                                <div class="d-flex">
                                                    <input type="number" class="form-control" id="patientBp" name="patientBp" value="<?php echo $value['bloodPressure'] ?>" min="0" placeholder="E.g. 100">
                                                    <p class="mx-2 my-2">mmHg</p>
                                                </div>
                                            </div>
                                            <div class="form-group pb-3">
                                                <label class="form-label" for="patientsCholestrol">Cholestrol </label>
                                                <div class="d-flex">
                                                    <input type="number" class="form-control" id="patientsCholestrol" name="patientsCholestrol" min="0" value="<?php echo $value['cholestrol'] ?>" placeholder="E.g. 50">
                                                    <p class="mx-2 my-2">mg/dl</p>
                                                </div>
                                            </div>
                                            <div class="form-group pb-3">
                                                <label class="form-label" for="patientBsugar">Blood Sugar </label>
                                                <div class="d-flex">
                                                    <input type="number" class="form-control" id="patientBsugar" name="patientBsugar" min="0" value="<?php echo $value['bloodSugar'] ?>" placeholder="E.g. 200">
                                                    <p class="mx-2 my-2">mmol/L</p>
                                                </div>
                                            </div>
                                            <div class="form-group pb-3">
                                                <label class="form-label" for="patientDiagonsis">Diagonsis <span class="text-danger">*</span></label>
                                                <textarea class="form-control" name="patientDiagonsis" id="patientDiagonsis" cols="" rows="" placeholder="E.g. Diabetes checkup"><?php echo $value['diagonsis']; ?></textarea>
                                                <div id="diagonsis_err" class="text-danger pt-1"></div>
                                            </div>
                                            <div class="form-group pb-3">
                                                <label class="form-label" for="patientSymptoms">Symptoms / Complaints <span class="text-danger">*</span></label>
                                                <input type="text" id="patientSymptoms" name="patientSymptoms" value="<?php echo $value['symptoms'] ?>" readonly class="form-control" placeholder="Select symptoms">
                                            ...
                                            <div class="form-group pb-3">
                                                ...
                                                <select class="form-control" id="patientMedicines" name="patientMedicines">
                                                    ...
                                                    ?>
                                                        <option value="<?php echo $mvalue['medicineBrand'] . " / " . $mvalue['medicineName'] . " / " . $mvalue['strength'] ?>">
                                            ...
                                            <div class="form-group pb-3">
                                                ...
                                                <input type="text" class="form-control" name="oldmedicalReceipts" value="<?php echo $value['documentOne']; ?>" hidden>
                                                <input type="file" class="form-control" id="medicalReceipts" name="medicalReceipts" accept="image/png ,image/jpg, image/jpeg, application/pdf" hidden>
                                                <div style="display:flex;">
                                                    <label id="file_mr" for="medicalReceipts" class="form-control" style="cursor:pointer">Choose File</label>
                                                    <a href="<?php echo base_url() . 'uploads/' . $value['documentOne']; ?>" class="ps-2 pt-1" style="display:none" target="blank" id="existfileMR">
                                            ...
                                            <div class="form-group pb-3">
                                                ...
                                                <input type="text" class="form-control" name="oldmedicalReports" value="<?php echo $value['documentTwo']; ?>" hidden>
                                                <input type="file" class="form-control" id="medicalReports" name="medicalReports" accept="image/png ,image/jpg, image/jpeg, application/pdf" hidden>
                                                <div style="display:flex;">
                                                    <label id="file_tu" for="medicalReports" class="form-control" style="cursor:pointer">Choose File</label>
                                                    <a href="<?php echo base_url() . 'uploads/' . $value['documentTwo']; ?>" class="ps-2 pt-1" style="display:none" target="blank" id="existfileTU">
                                                        <i class="bi bi-box-arrow-up-right me-2"> </i> Open </a>
                                                </div>
                                            </div>
                                            ...
                                            <div class="d-flex justify-content-between mt-3">
                                                ...
                                                <button type="submit" class="btn text-light" style="background-color: #00ad8e;" onclick="return validatePatientDetails()">Submit</button>
                                            </div>
                                        </form>
            ...
            <section>
                <div class="card rounded">
                    <div class="d-flex justify-content-between mt-2 p-2 pt-sm-4 px-sm-4">
                        ...
                        <button onclick="goBack()" class="border-0 bg-light float-end text-dark"><i class="bi bi-arrow-left"></i> Back</button>
                    </div>
                    <div class="card-body p-2 p-sm-5">
                        ...
                        ?>
                            <div class="d-sm-flex justify-content-evenly mt-2 mb-5">
                                ...
                                <?php if (isset($value['profilePhoto']) && $value['profilePhoto'] != "No data") { ?>
                                    <img src="<?php echo base_url() . 'uploads/' . $value['profilePhoto'] ?>" alt="Profile Photo" width="140" height="140" class="rounded-circle">
                                <?php } else { ?>
                                    <img src="<?php echo base_url(); ?>assets/BlankProfile.jpg" alt="Profile Photo" width="140" height="140" class="rounded-circle">
                                <?php } ?>
                            </div>

                            <h5 class="my-3 fw-bolder">Personal Details:</h5>
                            <div class="d-md-flex">
                                <p class="col-sm-6"><span class="text-secondary ">Mobile number</span> - <a href="tel:<?php echo $value['mobileNumber'] ?>" class="text-decoration-none text-dark">
                                        <?php echo $value['mobileNumber'] ?></a></p>
                                <p><span class="text-secondary ">Mail</span> - <a href="mailto:<?php echo $value['mailId'] ?>" class="text-decoration-none text-dark">
                            ...
                            <?php if ($value['documentOne'] != "No data" || $value['documentTwo'] != "No data") { ?>
                                ...
                                <div class="d-md-flex">
                                    <?php if ($value['documentOne'] != "No data") { ?>
                                        <p class="col-sm-6"><span class="text-secondary ">Medical Receipts</span> - <a href="<?php echo base_url() . 'uploads/' . $value['documentOne'] ?>" target="blank" rel="Document 1"> <i class="bi bi-box-arrow-up-right"></i> Open</a> </p>
                                    <?php } ?>
                                    <?php if ($value['documentTwo'] != "No data") { ?>
                                        <p><span class="text-secondary ">Test uploads</span> - <a href="<?php echo base_url() . 'uploads/' . $value['documentTwo'] ?>" target="blank" rel="Document 2"> <i class="bi bi-box-arrow-up-right"></i> Open</a> </p>
                                    <?php } ?>
                                </div>
                        <?php }
                        } ?>
            ...
            <section>
                <div class="card rounded">
                    <div class="d-sm-flex justify-content-between mt-2 p-2 pt-sm-4 px-sm-4">
                        ...
                        <a href="<?php echo base_url() . "Healthcareprovider/appointmentsForm" ?>"> <button style="background-color: #00ad8e;" class="float-end text-light border-0 rounded p-2">
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td style="font-size: 16px">
                                                    <a href="<?php echo base_url() . "Healthcareprovider/patientdetails/" . $value['patientDbId']; ?>" class="text-dark" onmouseover="style='text-decoration:underline'" onmouseout="style='text-decoration:none'">
                                                ...
                                                <td style="font-size: 16px">
                                                    <a href="<?php echo base_url() . "Healthcareprovider/chiefDoctorsProfile/" . $value['referalDoctorDbId']; ?>" class="text-dark" onmouseover="style='text-decoration:underline'" onmouseout="style='text-decoration:none'">
            ...
            <section>
                <div class="card rounded">
                    <div class="d-flex justify-content-between mt-2 p-2 pt-sm-4 px-sm-4">
                        ...
                        <a href="<?php echo base_url() . "Healthcareprovider/appointments" ?>" class="float-end text-dark"><i class="bi bi-arrow-left"></i> Back</a>
                    </div>
                    <div class="card-body px-md-4 pb-4">
                        ...
                        <div>
                            <div class="col-md-8">
                                <form action="<?php echo base_url() . "Healthcareprovider/newAppointment" ?>" method="POST" name="patientDetails" onsubmit="return validateAppointment()" oninput="clearErrorAppointment()">
                                    <div>
                                        ...
                                        <div class="form-group pb-3">
                                            ...
                                            <select class="form-control" id="dayTime" name="dayTime" onchange="displayTime()">
                                        ...
                                        <div class="py-2" id="morningTime" style="display:none"><i class="bi bi-brightness-alt-high"></i>, Morning Consult time,<br>
                                            <button type="button" class="timeButton btn btn-outline-secondary my-1" value="08:30">08:30 AM</button>
                                            <button type="button" class="timeButton btn btn-outline-secondary my-1" value="08:40">08:40 AM</button>
                                            <button type="button" class="timeButton btn btn-outline-secondary my-1" value="08:50">08:50 AM</button>
                                            <button type="button" class="timeButton btn btn-outline-secondary my-1" value="09:00">09:00 AM</button>
                                            <button type="button" class="timeButton btn btn-outline-secondary my-1" value="09:10">09:10 AM</button>
                                            <button type="button" class="timeButton btn btn-outline-secondary my-1" value="09:20">09:20 AM</button>
                                            <button type="button" class="timeButton btn btn-outline-secondary my-1" value="09:30">09:30 AM</button>
                                            <button type="button" class="timeButton btn btn-outline-secondary my-1" value="09:40">09:40 AM</button>
                                            <button type="button" class="timeButton btn btn-outline-secondary my-1" value="09:50">09:50 AM</button>
                                            <button type="button" class="timeButton btn btn-outline-secondary my-1" value="10:00">10:00 AM</button>
                                            <button type="button" class="timeButton btn btn-outline-secondary my-1" value="10:10">10:10 AM</button>
                                            <button type="button" class="timeButton btn btn-outline-secondary my-1" value="10:20">10:20 AM</button>
                                            <button type="button" class="timeButton btn btn-outline-secondary my-1" value="10:30">10:30 AM</button>
                                            <button type="button" class="timeButton btn btn-outline-secondary my-1" value="10:40">10:40 AM</button>
                                            <button type="button" class="timeButton btn btn-outline-secondary my-1" value="10:50">10:50 AM</button>
                                            <button type="button" class="timeButton btn btn-outline-secondary my-1" value="11:00">11:00 AM</button>
                                            <button type="button" class="timeButton btn btn-outline-secondary my-1" value="11:10">11:10 AM</button>
                                            <button type="button" class="timeButton btn btn-outline-secondary my-1" value="11:20">11:20 AM</button>
                                            <button type="button" class="timeButton btn btn-outline-secondary my-1" value="11:30">11:30 AM</button>
                                            <button type="button" class="timeButton btn btn-outline-secondary my-1" value="11:40">11:40 AM</button>
                                            <button type="button" class="timeButton btn btn-outline-secondary my-1" value="11:50">11:50 AM</button>

                                        </div>
                                        <div class="py-2" id="afternoonTime" style="display:none"><i class="bi bi-sun"></i>,
                                            Afternoon Consult time,<br>
                                            <button type="button" class="timeButton btn btn-outline-secondary my-1" value="12:00">12:00 PM</button>
                                            <button type="button" class="timeButton btn btn-outline-secondary my-1" value="12:10">12:10 PM</button>
                                            <button type="button" class="timeButton btn btn-outline-secondary my-1" value="12:20">12:20 PM</button>
                                            <button type="button" class="timeButton btn btn-outline-secondary my-1" value="12:30">12:30 PM</button>
                                            <button type="button" class="timeButton btn btn-outline-secondary my-1" value="12:40">12:40 PM</button>
                                            <button type="button" class="timeButton btn btn-outline-secondary my-1" value="12:50">12:50 PM</button>
                                            <button type="button" class="timeButton btn btn-outline-secondary my-1" value="13:00">01:00 PM</button>
                                            <button type="button" class="timeButton btn btn-outline-secondary my-1" value="13:10">01:10 PM</button>
                                            <button type="button" class="timeButton btn btn-outline-secondary my-1" value="13:20">01:20 PM</button>
                                            <button type="button" class="timeButton btn btn-outline-secondary my-1" value="13:30">01:30 PM</button>
                                            <button type="button" class="timeButton btn btn-outline-secondary my-1" value="13:40">01:40 PM</button>
                                            <button type="button" class="timeButton btn btn-outline-secondary my-1" value="13:50">01:50 PM</button>
                                            <button type="button" class="timeButton btn btn-outline-secondary my-1" value="14:00">02:00 PM</button>
                                            <button type="button" class="timeButton btn btn-outline-secondary my-1" value="14:10">02:10 PM</button>
                                            <button type="button" class="timeButton btn btn-outline-secondary my-1" value="14:20">02:20 PM</button>
                                            <button type="button" class="timeButton btn btn-outline-secondary my-1" value="14:30">02:30 PM</button>
                                            <button type="button" class="timeButton btn btn-outline-secondary my-1" value="14:40">02:40 PM</button>
                                            <button type="button" class="timeButton btn btn-outline-secondary my-1" value="14:50">02:50 PM</button>

                                        </div>
                                        <div class="py-2" id="eveningTime" style="display:none"><i class="bi bi-brightness-alt-high"></i>, Evening Consult time,<br>
                                            <button type="button" class="timeButton btn btn-outline-secondary my-1" value="17:30">05:30 PM</button>
                                            <button type="button" class="timeButton btn btn-outline-secondary my-1" value="17:40">05:40 PM</button>
                                            <button type="button" class="timeButton btn btn-outline-secondary my-1" value="17:50">05:50 PM</button>
                                            <button type="button" class="timeButton btn btn-outline-secondary my-1" value="18:00">06:00 PM</button>
                                            <button type="button" class="timeButton btn btn-outline-secondary my-1" value="18:10">06:10 PM</button>
                                            <button type="button" class="timeButton btn btn-outline-secondary my-1" value="18:20">06:20 PM</button>
                                            <button type="button" class="timeButton btn btn-outline-secondary my-1" value="18:30">06:30 PM</button>
                                            <button type="button" class="timeButton btn btn-outline-secondary my-1" value="18:40">06:40 PM</button>
                                            <button type="button" class="timeButton btn btn-outline-secondary my-1" value="18:50">06:50 PM</button>
                                            <button type="button" class="timeButton btn btn-outline-secondary my-1" value="19:00">07:00 PM</button>
                                            <button type="button" class="timeButton btn btn-outline-secondary my-1" value="19:10">07:10 PM</button>
                                            <button type="button" class="timeButton btn btn-outline-secondary my-1" value="19:20">07:20 PM</button>
                                            <button type="button" class="timeButton btn btn-outline-secondary my-1" value="19:30">07:30 PM</button>
                                            <button type="button" class="timeButton btn btn-outline-secondary my-1" value="19:40">07:40 PM</button>
                                            <button type="button" class="timeButton btn btn-outline-secondary my-1" value="19:50">07:50 PM</button>

                                        </div>
                                        <div class="py-2" id="nightTime" style="display:none"><i class="bi bi-moon-stars"></i>, Night Consult time,<br>
                                            <button type="button" class="timeButton btn btn-outline-secondary my-1" value="20:00">08:00 PM</button>
                                            <button type="button" class="timeButton btn btn-outline-secondary my-1" value="20:10">08:10 PM</button>
                                            <button type="button" class="timeButton btn btn-outline-secondary my-1" value="20:20">08:20 PM</button>
                                            <button type="button" class="timeButton btn btn-outline-secondary my-1" value="20:30">08:30 PM</button>
                                            <button type="button" class="timeButton btn btn-outline-secondary my-1" value="20:40">08:40 PM</button>
                                            <button type="button" class="timeButton btn btn-outline-secondary my-1" value="20:50">08:50 PM</button>
                                            <button type="button" class="timeButton btn btn-outline-secondary my-1" value="21:00">09:00 PM</button>
                                            <button type="button" class="timeButton btn btn-outline-secondary my-1" value="21:10">09:10 PM</button>
                                            <button type="button" class="timeButton btn btn-outline-secondary my-1" value="21:20">09:20 PM</button>
                                            <button type="button" class="timeButton btn btn-outline-secondary my-1" value="21:30">09:30 PM</button>
                                            <button type="button" class="timeButton btn btn-outline-secondary my-1" value="21:40">09:40 PM</button>
                                            <button type="button" class="timeButton btn btn-outline-secondary my-1" value="21:50">09:50 PM</button>
                                            <button type="button" class="timeButton btn btn-outline-secondary my-1" value="22:00">10:00 PM</button>
                                            <button type="button" class="timeButton btn btn-outline-secondary my-1" value="22:10">10:10 PM</button>

                                        </div>
                                        <div class="form-group pb-3">
                                            <label class="form-label" for="appTime">Time <span class="text-danger">*</span></label>
                                            <input type="text" class="form-control" id="appTime" name="appTime" placeholder="E.g. Select time" readonly>
                                            <div id="appTime_err" class="text-danger pt-1"></div>
                                        </div>
                                        <div class="form-group pb-3">
                                            <label class="form-label" for="appReason">Patient's Complaint / Symptoms<span class="text-danger">*</span></label>
                                            <input type="text" id="appReason" name="appReason" readonly class="form-control" hidden>
                ...
                <div class="card rounded">
                    <div class="d-sm-flex justify-content-between p-3">
                        ...
                        <div class="input-group pt-2 pt-sm-0" style="width:250px;">
                            ...
                            <input type="text" id="searchInputChiefDoctor" class="form-control" placeholder="Search by name" aria-describedby="searchIcon">
                        ...
                        <div class="d-sm-flex justify-content-start mt-2 mb-5">
                            ...
                            ?>
                                <?php if (isset($value['ccPhoto']) && $value['ccPhoto'] != "") { ?>
                                    <img src="<?php echo $value['ccPhoto'] ?>" alt="Profile Photo" width="140" height="140" class="rounded-circle">
                                <?php } else { ?>
                                    <img src="<?php echo base_url(); ?>assets/BlankProfile.jpg" alt="Profile Photo" width="140" height="140" class="rounded-circle my-auto">
                                <?php } ?>
                                <div class="ps-sm-5">
                                    ...
                                    <p><a href="tel:<?php echo $value['doctorMobile']; ?>" style="font-size:16px;font-weight:400;" class="text-decoration-none text-dark fs-6">+91
                                            <?php echo $value['doctorMobile']; ?>
                                        </a> | <a href="mailto:<?php echo $value['doctorMail']; ?>" style="font-size:16px;font-weight:400;" class="text-decoration-none text-dark fs-6">
            ...
            <section>
                <div class="card rounded">
                    <div class="d-flex justify-content-between mt-2 p-2 pt-sm-4 px-sm-4">
                        ...
                        <a href="<?php echo base_url() . "Healthcareprovider/dashboard" ?>" class="float-end text-dark"><i class="bi bi-arrow-left"></i> Back</a>
                    </div>
                    <div class="card-body p-2 p-sm-4">
                        <?php
                        ...
                        ?>
                            <div class="d-sm-flex justify-content-start mt-2 mb-5">
                                <?php if (isset($value['hcpPhoto']) && $value['hcpPhoto'] != "") { ?>
                                    <img src="<?php echo $value['hcpPhoto'] ?>" alt="Profile Photo" width="140" height="140" class="rounded-circle">
                                <?php } else { ?>
                                    <img src="<?php echo base_url(); ?>assets/BlankProfile.jpg" alt=" Profile Photo" width="140" height="140" class="rounded-circle">
                                <?php } ?>
                                <div class="ps-sm-5">
                                    ...
                                    <p><a href="tel:<?php echo $value['hcpMobile']; ?>" style="font-size:16px;font-weight:400;" class="text-decoration-none text-dark fs-6">+91
                                            <?php echo $value['hcpMobile']; ?>
                                        </a> | <a href="mailto:<?php echo $value['hcpMail']; ?>" style="font-size:16px;font-weight:400;" class="text-decoration-none text-dark fs-6">
            ...
            <section>
                <div class="card rounded">
                    <div class="d-flex justify-content-between mt-2 p-2 pt-sm-4 px-sm-4">
                        ...
                        <a href="<?php echo base_url() . "Healthcareprovider/myProfile" ?>" class="float-end text-dark"><i class="bi bi-arrow-left"></i> Back</a>
                    </div>
                    <div class="card-body ps-2 p-sm-4">
                        <div class="">
                            <div class="position-relative mb-5">
                                ...
                                ?>
                                    <?php if (isset($value['hcpPhoto']) && $value['hcpPhoto'] != "") { ?>
                                        <img src="<?php echo $value['hcpPhoto'] ?>" alt="Profile Photo" width="180" height="180" class="rounded-circle">
                                    <?php } else { ?>
                                        <img src="<?php echo base_url(); ?>assets/BlankProfile.jpg" alt="Profile Photo" width="180" height="180" class="rounded-circle">
                                    <?php } ?>
                                    <button class="position-absolute bottom-0 " type="button" data-toggle="modal" data-target="#updatePhoto"><i class="bi bi-pencil-square"></i></button>
                            </div>


                            <form action="<?php echo base_url() . "Healthcareprovider/updateMyProfile" ?>" name="profileEditForm" name="profileEditForm" enctype="multipart/form-data" method="POST" onsubmit="return validateDetails()" oninput="clearErrorDetails()" class="col-md-6">

                                <div class="form-group pb-3">
                                    <label class="form-label" for="drName">Name <span class="text-danger">*</span></label>
                                    <input type="text" class="form-control" id="drName" name="drName" value="<?php echo $value['hcpName']; ?>" placeholder="E.g. Suresh Kumar">
                                    <div id="drName_err" class="text-danger pt-1"></div>
                                </div>
                                <div class="form-group pb-3">
                                    <label class="form-label" for="drMobile">Mobile <span class="text-danger">*</span></label>
                                    <input type="number" class="form-control" id="drMobile" name="drMobile" value="<?php echo $value['hcpMobile']; ?>" placeholder="E.g. 9632587410">
                                    <div id="drMobile_err" class="text-danger pt-1"></div>
                                </div>
                                <div class="form-group pb-3">
                                    <label class="form-label" for="drEmail">Email <span class="text-danger">*</span></label>
                                    <input type="email" class="form-control" id="drEmail" name="drEmail" value="<?php echo $value['hcpMail']; ?>" placeholder="E.g. example@gmail.com">
                                    <div id="drEmail_err" class="text-danger pt-1"></div>
                                </div>
                                <div class="form-group pb-3 ">
                                    <label class="form-label" for="drPassword">Password <span class="text-danger">*</span></label>
                                    <div class="d-flex">
                                        <input type="password" class="form-control" id="drPassword" name="drPassword" value='<?php echo $value['hcpPassword']; ?>'>
                                        <button type="button" class="btn btn-outline-secondary" onclick="togglePasswordVisibility('drPassword', 'visibilityIcon')">
                                ...
                                <div class="form-group pb-3">
                                    ...
                                    <input type="text" class="form-control" id="yearOfExp" name="yearOfExp" value="<?php echo $value['hcpExperience']; ?>" placeholder="E.g. 25">
                                    <!-- <div id="drName_err" class="text-danger pt-1"></div> -->
                                </div>
                                <div class="form-group pb-3">
                                    <label class="form-label" for="qualification">Qualification</label>
                                    <input type="text" class="form-control" id="qualification" name="qualification" value="<?php echo $value['hcpQualification']; ?>" placeholder="E.g. MBBS">
                                    <!-- <div id="drName_err" class="text-danger pt-1"></div> -->
                                </div>
                                <div class="form-group pb-3">
                                    <label class="form-label" for="dob">Date of Birth</label>
                                    <input type="date" class="form-control" id="dob" name="dob" value="<?php echo $value['hcpDob']; ?>">
                                    <!-- <div id="drName_err" class="text-danger pt-1"></div> -->
                                </div>
                                <div class="form-group pb-3">
                                    <label class="form-label" for="hospitalName">Hospital / Clinic Name</label>
                                    <input type="text" class="form-control" id="hospitalName" name="hospitalName" value="<?php echo $value['hcpHospitalName']; ?>" placeholder="E.g. MMCH">
                                    <!-- <div id="specialization_err" class="text-danger pt-1"></div> -->
                                </div>
                                <div class="form-group pb-3">
                                    <label class="form-label" for="location">Location</label>
                                    <input type="text" class="form-control" id="location" name="location" value="<?php echo $value['hcpLocation']; ?>" placeholder="E.g. Erode">
                                    <!-- <div id="specialization_err" class="text-danger pt-1"></div> -->
                                </div>

                                <button type="reset" class="btn btn-secondary float-start mt-3">Reset</button>
                                <button type="submit" class="btn float-end mt-3" style="color: white;background-color: #00ad8e;">Save</button>
                            </form>
                        </div><?php } ?>
                    </div>
                </div>
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="<?php echo base_url() . "Healthcareprovider/updatePhoto" ?>" name="profilePhotoForm" name="profilePhotoForm" enctype="multipart/form-data" method="POST">
                            <label for="hcpProfile" class="pb-2">Upload file: </label><br>
                            <input type="file" name="hcpProfile" id="hcpProfile" accept="image/png ,image/jpg, image/jpeg" required><br><br>
        ...
        <div class="modal fade" id="updateProfile" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="<?php echo base_url() . "Healthcareprovider/updatePatientPhoto" ?>" name="profilePhotoForm" name="profilePhotoForm" enctype="multipart/form-data" method="POST">
                            <label for="hcpProfile" class="pb-2">Upload file: </label><br>
                            <input type="file" name="patientProfile" id="patientProfile" accept="image/png ,image/jpg, image/jpeg" required><br><br>
