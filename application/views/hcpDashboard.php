                        ...
                        if (itemsToShow.length === 0) {
                            ...
                            itemsToShow.forEach((value, index) => {
                                ...
                                patientRow.innerHTML = `
                                                <td>${start + index + 1}.</td>
                                                <td class="px-2">
                                                    <img src="${value.profilePhoto && value.profilePhoto !== 'No data' ? '<?php echo base_url(); ?>uploads/' + value.profilePhoto : '<?php echo base_url(); ?>assets/BlankProfile.jpg'}" alt="Profile Photo" width="40" height="40" class="rounded-circle">
                                                </td >
