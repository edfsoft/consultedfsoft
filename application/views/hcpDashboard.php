                    ...
                    <div class="card-body p-4">
                        ...
                        <div class="rounded-4 shadow-sm p-3" style="border: 2px solid #000; border-radius: 20px;">
                            ...
                            <div class="d-flex justify-content-between align-items-center mb-3"
                                ...
                                <button id="prevDayBtn" class="btn btn-link text-white fw-bold p-0" style="font-size: 1.5rem;">
                                ...
                                <button id="nextDayBtn" class="btn btn-link text-white fw-bold p-0" style="font-size: 1.5rem;">
