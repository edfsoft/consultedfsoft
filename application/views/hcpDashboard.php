            ...
            ?>
                ...
                <?php if (isset($appointmentReschedule[0]['id'])) { ?>
                                            ...
                                            <div class="card rounded">
                                                ...
                                                <div class="card-body p-2 p-sm-4">
                                                    <div class="table-responsive">
                                                        <table class="table text-center" id="appointmentReschedule">
                                                            <thead>
                                                                <tr>
                                                                    <th scope="col" style="font-size: 16px; font-weight: 500; color: #00ad8e">S.NO</th>
                                                                    <th scope="col" style="font-size: 16px; font-weight: 500; color: #00ad8e">PATIENT ID
            ...
            ?>
                            ...
                            <?php }
                                                            ...
                                                            <form action="<?php echo base_url() . "Healthcareprovider/prescriptionForm" ?>" method="POST"
                                                                name="prescriptionForm" class="col-md-6">
                                                                ...
                                                                <div class="form-group pb-3">
                                                                    <label class="form-label" for="preMedName">Medicines <span
                                                                            class="text-danger">*</span></label>
                                                                    <input type="text" class="form-control" id="preMedName" name="preMedName"
                                                                ...
                                                                <div class="form-group pb-3">
                                                                    <label class="form-label" for="preMedFrequency">Frequency <span
                                                                            class="text-danger">*</span></label>
                                                                    <input type="text" class="form-control" id="preMedFrequency" name="preMedFrequency"
                                                                        placeholder="1 - 0 - 1" maxlength="9" required>
                                                                ...
                                                                <div class="form-group pb-3">
                                                                    ...
                                                                    <div class="input-group">
                                                                        <input type="number" class="form-control" id="preMedDuration" name="preMedDuration"
                                                                            placeholder="Enter duration" min="1" max="31" required>
                                                                        <select class="form-select" id="preMedDurationUnit" name="preMedDurationUnit" required>
                                                                ...
                                                                <div class="form-group pb-3">
                                                                    <label class="form-label" for="preMedNotes">Notes <span class="text-danger">*</span></label>
                                                                    <select class="form-select" id="preMedNotes" name="preMedNotes" required>
                                                ...
                                                <script>
                                                    document.getElementById('preMedFrequency').addEventListener('input', function (event) {
                                                        let value = event.target.value.replace(/[^01]/g, '');
                                                        ...
                                                        const pattern = /^[0-1]\s-\s[0-1]\s-\s[0-1]$/;
                                                        const errorDiv = document.getElementById('preMedFrequency_err');
