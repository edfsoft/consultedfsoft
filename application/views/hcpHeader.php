            ...
            <li class="nav-item dropdown d-flex justify-content-evenly">
                ...
                <div class="ps-3">
                    <a class="d-flex align-items-center text-dark fw-medium" href="#" data-bs-toggle="dropdown"
                        ...
                        <?php echo $_SESSION['hcpsName']; ?> <span class="dropdown-toggle mx-2 mx-sm-3"></span>
                    </a>
                    <span class="fw-medium" style="font-size:16px;color: #00ad8e;">HCP</span>

                    <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile"
                        style="box-shadow: 0 0 10px 5px rgba(0, 0, 0, 0.2);">
                        <li class="dropdown-header">
                            <p class="fs-6 fw-medium text-dark"> <?php echo $_SESSION['hcpsName']; ?> / </p>
