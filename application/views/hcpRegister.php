    ...
    <script>
        function validateSignup() {
            ...
            if (mobile == "") {
                ...
                document.getElementById("mobile_err").innerHTML = "Invalid mobile number. Please enter valid mobile number.";
                return false;
            } else {
            ...
            if (email == "") {
                ...
                document.getElementById("mail_err").innerHTML = "Invalid email address. Please enter valid email address.";
                return false;
            } else {
