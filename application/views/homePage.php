...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light px-5">
        <div class="container-fluid">
            <a class="navbar-brand" href="https://www.erodediabetesfoundation.org/" target="blank"><img src="<?php echo base_url(); ?>assets/edf_logo.png" alt="logo"></a>
            ...
            <div class="collapse navbar-collapse ps-5" id="navbarNavDropdown">
                <ul class="navbar-nav ps-5">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle text-dark me-4" href="#" id="navbarDropdownMenuLink" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                            Services
                        </a>
                        <ul class="dropdown-menu border-0 rounded-3 shadow mt-2 p-2" aria-labelledby="navbarDropdownMenuLink">
                            <li><a class="dropdown-item" href="#services">Online Consultation</a></li>
                            <li><a class="dropdown-item" href="https://erodediabetesfoundation.org/service/diabetes-consult/" target="blank">Diabetes Consult</a></li>
                        </ul>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link text-dark me-4" href="https://www.erodediabetesfoundation.org/blog/" target="blank">Blogs</a>
                    </li>
                    <li class="nav-item">
            ...
            <div class="d-flex text-center">
                <div class="dropdown me-4 me-sm-0">
                    <button class="btn rounded-pill text-light me-sm-4 px-4" style="background-color:#00AD8E;" type="button" id="dropDownLogin" data-bs-toggle="dropdown" aria-expanded="false">
                        Login
                    </button>
                    <ul class="dropdown-menu border-0 rounded-3 shadow mt-3 p-2" style="transform: translateX(-50px);" aria-labelledby="dropDownLogin">
                ...
                <div class="dropdown ms-4 ms-sm-0">
                    <button class="btn btn-danger rounded-pill text-light px-4" type="button" id="dropDownSignup" data-bs-toggle="dropdown" aria-expanded="false">
                        Signup
                    </button>
                    <ul class="dropdown-menu border-0 rounded-3 shadow mt-3 p-2" style="transform: translateX(-70px);" aria-labelledby="dropDownSignup">
    ...
    <div class="d-lg-flex justify-content-between pt-sm-5 ps-sm-5" style="background-color:#EEF6F5;">
        <div class="m-4 ms-sm-5 mt-3 mt-sm-5 pt-4 pt-sm-0 fs-1" style="font-weight:500;">
            ...
            <p class="pt-3" style="font-size:18px;font-weight:400;"> Online Video Consultations With <br> Expert
                Diabetologists.</p>
            <a href="<?php echo base_url() . "Healthcareprovider/appointmentsForm" ?>"><img src="<?php echo base_url(); ?>assets/bookAppointBtn.png" alt="book"></a>
        </div>
    ...
    <!-- Why choose -->
    <div id="whychooseus" class="py-5 position-relative" style="background-color:#FFF4F4;background-image: url('<?php echo base_url(); ?>assets/whysvg2.svg');background-repeat: no-repeat;background-position: right top;z-index:-2;">
        ...
        <div class="d-lg-flex justify-content-evenly pt-lg-4">
            <div class="col-lg-2 text-center"> <img class="mt-lg-5 pt-3" src="<?php echo base_url(); ?>assets/choose1.png" alt="1">
            ...
            <div class="col-lg-2 text-center"> <img class="pt-3 pb-lg-2 " src="<?php echo base_url(); ?>assets/choose2.png" alt="2">
            ...
            <div class="col-lg-2 text-center"> <img class="pt-3 mt-lg-5" src="<?php echo base_url(); ?>assets/choose3.png" alt="3">
            ...
            <div class="col-lg-2 text-center"> <img class="pt-3 pt-lg-4 pb-lg-3" src="<?php echo base_url(); ?>assets/choose4.png" alt="4">
    ...
    <div id="testimonials" class="my-5">
        ...
        <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
            <div class="carousel-indicators" style="padding-top:100px;">
                <button type="button" data-bs-target="#carouselExampleIndicators" data-bs-slide-to="0" class="active" aria-current="true" aria-label="Slide 1" style="text-indent:0;"><span class="badge bg-success">
                    </span></button>
                <button type="button" data-bs-target="#carouselExampleIndicators" data-bs-slide-to="1" aria-label="Slide 2" style="text-indent:0;"><span class="badge bg-success"> </button>
                <button type="button" data-bs-target="#carouselExampleIndicators" data-bs-slide-to="2" aria-label="Slide 3" style="text-indent:0;"><span class="badge bg-success"> </button>
            </div>
    ...
    <!-- Footer -->
    <div id="contactus" class="container-fluid pt-5" style="background-image: url('<?php echo base_url(); ?>assets/footer.png');background-size: cover;background-position: center center;background-repeat: no-repeat;">
        <div class="row">
            <div class="col-12 text-center ">
                ...
                <div class="d-lg-flex justify-content-evenly ">
                    <p style="font-size:18px;font-weight:400;" class="text-light"><img src="<?php echo base_url(); ?>assets/phone-call.svg" alt="1"> <a href="tel:9789494299" style="font-size:18px;font-weight:400;" class="text-decoration-none text-light fs-6">+91
                            9789494299</a> , <a href="tel:04242264949" style="font-size:18px;font-weight:400;" class="text-decoration-none text-light fs-6">04242264949</a></p>
                    <p><a href="mailto:contact@erodediabetesfoundation.org" style="font-size:18px;font-weight:400;" class="text-decoration-none text-light fs-6"><img src="<?php echo base_url(); ?>assets/mail.svg" alt="1">
                            contact@erodediabetesfoundation.org</a></p>
                    <p><a href="https://www.google.com/maps/place/Maruthi+Medical+Center+Erode+-+Multispeciality+Hospitals%2FInfertility+Clinic%2FIVF+Treatment+Center%2FTest+Tube+Baby+Center%2FIUI+Center/@11.3383515,77.7104976,17z/data=!4m10!1m2!2m1!1s564,Perundurai+road,+Erode-11!3m6!1s0x3ba96f34f915e187:0xb1e50821faa81313!8m2!3d11.3381551!4d77.7130846!15sCh01NjQsUGVydW5kdXJhaSByb2FkLCBFcm9kZS0xMZIBEGZlcnRpbGl0eV9jbGluaWPgAQA!16s%2Fg%2F1ptvtx91z?entry=ttu" style="font-size:18px;font-weight:400;" target="blank" class="text-decoration-none text-light fs-6"><img src="<?php echo base_url(); ?>assets/location.svg" alt="1"> 564, Perundurai road,
                            Erode-11</a></p>
                </div>
                <p style="font-size:13px;font-weight:400;" class="text-light pt-2">Copyright © 2024 <a href="https://www.erodediabetesfoundation.org/" target="blank" style="font-size:13px;font-weight:400;" class="text-light">Erodediabetesfoundation</a> All
                    rights reserved.</p>
            </div>
        </div>
    </div>
