...
<head>
    ...
    <title>Patient Login Page - EDF</title>
        ...
        <div class="row" id="bgcolor">
            ...
            <div class="col-md-6">
                <div class="login-form mx-lg-2 mx-xxl-5 p-3 p-sm-4 p-xxl-5">
                    ...
                    <p class="text-justify" style="font-size:18px;font-weight:400;">Log in to manage your diabetes care
                    ...
                    <form action="<?php echo base_url() . "Patient/patientLogin" ?>" method="post"
                        ...
                        <div class="position-relative">
                            <label for="patientPassword" class="form-label">Password <span
                                    class="text-danger">*</span></label>
                            <input type="password" name="patientPassword" id="patientPassword" placeholder="password"
